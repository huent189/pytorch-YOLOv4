...
def detect_skimage(cfgfile, weightfile, imgfiles):
    ...
    for imgfile in imgfiles:
      ...
      plot_boxes_cv2(img, boxes, savename=os.path.join('/content/yolo_out', os.path.split(imgfile)[-1]), class_names=class_names)
